...
/// Level summary for one sampled waveform interval.
...
#[derive(Clone, Copy, Debug)]
/// Bounded output grid used by finite and growing waveform indexes.
pub struct WaveformSummaryGrid {
    pub start_sample: u64,
    pub available_end_sample: u64,
    pub grid_end_sample: u64,
    pub target_points: usize,
}

pub(crate) use WaveformSummary as GroupSummary;
pub(crate) use WaveformSummaryGrid as SummaryGrid;

/// Projects interval summaries onto one bounded sampled waveform channel.
pub fn sample_waveform_summary_channel(
    channel: usize,
    name: String,
    initial: bool,
    grid: WaveformSummaryGrid,
    mut summarize: impl FnMut(u64, u64, bool) -> Result<WaveformSummary>,
...
pub(crate) use sample_waveform_summary_channel as sample_summary_channel;
