...
use signal_derived::{NumberLaneSnapshot, OpaqueCollectedLaneSnapshot};
...
inventory::submit! {
    PayloadRegistration::subscribable_with_persistent_cache::<signal_derived::NumberSample>(
        "org.logicconduit.number-sample/v1",
        signal_derived::number_payload_adapter,
        presentation,
    )
}
