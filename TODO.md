...
3. **Concrete processing boundaries:**
   ...
   - Put Sigrok decoder execution behind an owner-controlled contract, separate
     from the search-path and Python-package discovery contracts. Runtime tests
     use only project-owned decoder packages.
