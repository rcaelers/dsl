...
//!
//! Each child module owns one concrete decoding state machine and its supported
//! configuration/factory contract. Graph sockets and protocol presentation are
//! supplied by the corresponding graph-node feature.
