...
Logic: Packet Framer, Word Field Extractor, Word Matcher, Edge Detector (edge selection,
debounce, and preceding-pulse qualification), Event Gate (signal-controlled trigger filtering),
