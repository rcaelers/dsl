...
generic work execution. Its crate root is the supported facade; implementation modules are private.
...
dispatch, cancellation, and shutdown. Architecture tests reject signal-domain and storage
dependencies.
