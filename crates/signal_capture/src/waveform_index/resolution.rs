...
pub fn select_waveform_summary_resolution(
    window_samples: u64,
    target_points: usize,
...
pub(crate) use select_waveform_summary_resolution as select_summary_resolution;

#[cfg(test)]
mod resolution_tests {
    use super::select_waveform_summary_resolution;

    #[test]
    fn selects_same_mipmap_scale_for_a_window_and_point_budget() {
        let resolutions = [64, 4_096, 262_144, 16_777_216];
        assert_eq!(
            select_waveform_summary_resolution(100_000, 1_000, resolutions),
            Some(64)
        );
        assert_eq!(
            select_waveform_summary_resolution(1_048_576, 100, resolutions),
            Some(4_096)
        );
        assert_eq!(
            select_waveform_summary_resolution(100_000_000, 100, resolutions),
            Some(262_144)
        );
    }
}
