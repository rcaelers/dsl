...
mod implementation {
    ...
    use signal_runtime::{Pipeline, ProcessNode, Watchdog, WorkError};
    use signal_sinks::csv_word_writer::{CsvValueFormat, CsvWordWriter};
    ...
    pub(crate) fn main() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let mut decoder = SpiDecoder::new(SpiMode::Mode0, args.bits.clamp(1, 64), true, false);
        ...
        pipeline.connect("source", &format!("ch{}", args.mosi), "decoder", "mosi")?;
