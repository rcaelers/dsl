...
**Problem.** ~473 lines of `architecture_tests.rs` remain across the workspace that `include_str!`
...
2. Prioritize the UI `memory_panel` suite. Do not replace an implementation-text check with another
